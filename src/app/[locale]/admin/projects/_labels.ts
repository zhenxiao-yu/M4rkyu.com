...
export async function buildProjectFormLabels(locale: Locale) {
  ...
  return {
    ...
    product: t("section.product"),
    taglineLabel: t("taglineLabel"),
    taglineHint: t("taglineHint"),
    timelineLabel: t("timelineLabel"),
    timelineHint: t("timelineHint"),
    platformsLabel: t("platformsLabel"),
    platformsHint: t("platformsHint"),
    stackGroupsLabel: t("stackGroupsLabel"),
    stackGroupsHint: t("stackGroupsHint"),
    ...
    screenshots: {
      title: t("section.screenshots"),
      addTitle: t("screenshotAddTitle"),
      add: t("screenshotAdd"),
      labelLabel: t("screenshotLabelLabel"),
      labelHint: t("screenshotLabelHint"),
      captionLabel: t("screenshotCaptionLabel"),
      altLabel: t("screenshotAltLabel"),
      save: t("screenshotSave"),
      delete: t("screenshotDelete"),
      deleteConfirm: t("screenshotDeleteConfirm"),
      moveUp: t("screenshotMoveUp"),
      moveDown: t("screenshotMoveDown"),
      empty: t("screenshotsEmpty"),
      imageLabel: t("screenshotImageLabel"),
      imageHint: t("screenshotImageHint"),
    },
  };
}
