 ...
 * app hydrates.
 */
const BOOTSTRAP = `(function(){try{var d=document.documentElement;var s=localStorage.getItem('theme');var m=window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light';var r=(!s||s==='system')?m:s;d.setAttribute('data-theme',r);var P=['risograph','terminal','editorial','blueprint'];var p=localStorage.getItem('palette');d.setAttribute('data-palette',P.indexOf(p)>=0?p:'risograph');}catch(e){}})()`;
